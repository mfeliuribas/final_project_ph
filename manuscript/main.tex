...
\emph{fossa} {[}fósa{]} - \emph{fosa} {[}fóza{]} (Carrera-Sabaté \&
Prieto, 2012-2019). Conversely, at the end of the word, this contrast is
neutralized, being the voicing or devoicing of the alveolar fricative
dependent on the following sound (Institut d'Estudis Catalans, 2022).
